...
simforest_long = SimForest('simforest_long', similarity_func=cos_sim)
simforest_long.load_model()
simforest_short = SimForest('simforest_short', similarity_func=cos_sim)
simforest_short.load_model()
