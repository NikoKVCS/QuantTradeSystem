...
proxforest_long = ProximityForest('promixityforest_long', r=2)
proxforest_long.load_model()
proxforest_short = ProximityForest('promixityforest_short', r=2)
proxforest_short.load_model()
...
if __name__ == "__main__":
    ...
    simforest = ProximityForest('promixityforest_short', r=2)
    simforest.train(traindata.get('data_input'), traindata.get('data_output'), 2000, 1500, n_estimators=1)
    ...
    simforest = ProximityForest('promixityforest_long', r=2)
    simforest.train(traindata.get('data_input'), traindata.get('data_output'), 2000, 2000, n_estimators=1)
